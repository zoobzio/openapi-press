...
export default defineConfig({
  ...
  resolve: {
    alias: {
      "@openforge/nuxt/constant": fromHere("./src/constant.ts"),
      "@openforge/nuxt/util": fromHere("./src/util.ts"),
      "#imports": fromHere("./test/stubs/imports.ts"),
      "#build/openforge.mjs": fromHere("./test/stubs/build-openforge.ts"),
    },
  },
  ...
  define: {
    "import.meta.server": "globalThis.__openforgeServer__",
  },
  test: {
