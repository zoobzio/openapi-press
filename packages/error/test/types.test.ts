...
describe("PressErrorInit", () => {
  it("requires the request context and admits an optional cause", () => {
    expectTypeOf<PressErrorInit["message"]>().toEqualTypeOf<string>();
    expectTypeOf<PressErrorInit["method"]>().toEqualTypeOf<string>();
    expectTypeOf<PressErrorInit["path"]>().toEqualTypeOf<string>();
    expectTypeOf<PressErrorInit["cause"]>().toEqualTypeOf<unknown>();
  });
});

describe("HttpErrorInit", () => {
  it("extends the base init with the response fields", () => {
    expectTypeOf<HttpErrorInit>().toExtend<PressErrorInit>();
